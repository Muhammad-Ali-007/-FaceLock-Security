...
class Face_Recongition:
    def __init__(self, root):
        ...
        img6 = Image.open(r"C:\Users\Muhammad\OneDrive - National University of Sciences & Technology\Desktop\DSAProject\Pictures\process.jpg")
        ...
        try:
            def draw_boundray(img, classifier, scaleFactor, minNeighbors, color, text, clf):
                ...
                for (x, y, w, h) in features:
                    ...
                    # r = my_cursor.fetchone()    # only to fetch rollNumber
                    # r = r[0]
                    # r = "+".join(str(r))
                    # r = "+".join(r)
                    # r=str(r)
                    ...
                    # d = my_cursor.fetchone()    # only to fetch department
                    # d = d[0]
                    # d = "+".join(str(d))
                    # d = "+".join(d)
                    # n=str(n)
                    ...
                    # i = my_cursor.fetchone()    # only to fetch department
                    # i = n[0]
                    # i = "+".join(str(n))
                    # i = "+".join(i)
                    # i=str(i)
            ...
            # clf = face.......
            # clf = cv2.face_LBPHFaceRecognizer.create()
            # clf =  cv2.createFaceLBPHFaceRecognizer()
