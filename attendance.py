...
class Attendance:
    def __init__(self, root):
        ...
        # Department
        department_label = ttk.Label(insideTopFrame, text = "Department:", font = ("times new roman", 12, "bold"))
        ...
        # Update button
        save_buttonn = Button(buttonFrame, text= "Update", width=17, font = ("times new roman", 13, "bold"), bg="Red", fg="White")
        ...
        self.atttendanceReportTable = ttk.Treeview(tableFrame, columns= ("ID", "Roll", "Name", "Department", "Time", "Date", "Attendance"), xscrollcommand = scroll_x.set, yscrollcommand = scroll_y.set)
        ...
        self.atttendanceReportTable.heading("Roll", text = "Roll Number")
        self.atttendanceReportTable.heading("Name", text = "Name")
        self.atttendanceReportTable.heading("Department", text = "Department")
        ...
        self.atttendanceReportTable.column("Roll", width = 100)
        self.atttendanceReportTable.column("Name", width = 100)
        self.atttendanceReportTable.column("Department", width= 100)
