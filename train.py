...
class Train:
    def __init__(self, root):
        ...
        top_img = Image.open(r"C:\Users\Muhammad\OneDrive - National University of Sciences & Technology\Desktop\DSAProject\Pictures\train.jpg")
    ...
    def train_classifier(self):
        try:
            data_dir = (r"C:\Users\Muhammad\OneDrive - National University of Sciences & Technology\Desktop\DSAProject\data")
            ...
            # ids = np.array(ids.linked_list_to_numpy_array().tolist())
            # faces = np.array(faces.linked_list_to_numpy_array().tolist())
            ...
            # clf = cv.faces.LBPHFaceRecongnizer_create()
            # recognizer = cv.face.LBPHFaceRecognizer_create()
            # clf = cv.face.LBPHFaceRecongnizer_create()
            # clf = cv.
