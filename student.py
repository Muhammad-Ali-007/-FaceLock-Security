...
class Student:
    def __init__(self, root):
        ...
        img = Image.open(r"C:\Users\Muhammad\OneDrive - National University of Sciences & Technology\Desktop\DSAProject\Pictures\third.jpg")
        img = img.resize((500, 130), Image.LANCZOS)    # convert high level image to low level
        ...
        img1 = Image.open(r"C:\Users\Muhammad\OneDrive - National University of Sciences & Technology\Desktop\DSAProject\Pictures\second.jpg")
        img1 = img1.resize((550, 130), Image.LANCZOS)    # convert high level image to low level
        ...
        img2 = Image.open(r"C:\Users\Muhammad\OneDrive - National University of Sciences & Technology\Desktop\DSAProject\Pictures\first.jpg")
        img2 = img2.resize((550, 130), Image.LANCZOS)    # convert high level image to low level
        ...
        # bg image
        img3 = Image.open(r"C:\Users\Muhammad\OneDrive - National University of Sciences & Technology\Desktop\DSAProject\Pictures\background1.png")
        img3 = img3.resize((1530, 710), Image.LANCZOS)    # convert high level image to low level
        ...
        img_left = Image.open(r"C:\Users\Muhammad\OneDrive - National University of Sciences & Technology\Desktop\DSAProject\Pictures\second.jpg")
        ...
        dep_combo["values"] = ("Select Department", "Computer Science", "Civil Engineering")
        dep_combo.current(0)
        ...
        # Update Photo button
        update_photo_buttonn = Button(buttonFrame01, text= "Update Photo Sample", width=35, font = ("times new roman", 13, "bold"), bg= "yellow", fg = "black")
        ...
        # Search Entry
        search_entry = ttk.Entry(search_frame, font = ("times new roman", 12))
        search_entry.grid(row=0, column=2, padx= 4)

        # Search button
        search_buttonn = Button(search_frame, text= "Search", width=9, font = ("times new roman", 13, "bold"), bg="Green", fg="White")
        search_buttonn.grid(row=0, column= 3, padx= 5)

        # update button
        show_all_buttonn = Button(search_frame, text= "Show All", width=9, font = ("times new roman", 13, "bold"), bg="Yellow", fg="Black")
